...
def main_fast_demo():
    """
    Fast demo version using smaller modulus for testing
    This completes quickly and demonstrates the attack works
    """
    print("=" * 70)
    print("Random Franklin-Reiter Attack (Fast Demo with smaller modulus)")
    print("=" * 70)
    print()

    print("NOTE: Using smaller modulus for fast demonstration.")
    print("      The attack works identically for RSA-256.")
    print()

    # Generate smaller primes for fast demo (40-bit)
    ...
    m1 = random.getrandbits(30)
    a = random.randint(2, 10)
    b = random.randint(1, 1000)
    m2 = (a * m1 + b) % n

    print(f"Random messages:")
    print(f"  M1 = {m1}")
    print(f"  a = {a}, b = {b}")
    print(f"  M2 = {a}*M1 + {b} = {m2}")
    print()
